                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="row mb-5">
                            ...
                            <form method="POST" action="create-driver" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-lg-5 col-md-6 mb-md-0 mb-4">
                                    ...
                                    <input class="form-control form-control-lg" name="licence_no" autofocus >

                                </div>

                                <div class="col-lg-5 col-md-6 mb-md-0 mb-4">
                                    <label>Upload Licence</label>
                                    <input type="file" class="form-control form-control-lg" name="licence_image" autofocus >
                                ...
                                <button a class="btn btn-block btn-primary btn-lg mt-4 font-weight-medium auth-form-btn"
                                    name="submit" type="submit">Create Driver</a></button>
                                    ...
                                    <table class="table align-items-center mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($customers as $item)
                                                <tr>
                                                    <td><a href="/view-driver/?id={{ $item->id }}">{{ $item->f_name }}
                                                            {{ $item->l_name }}</a>
                                                    </td>
                                                    <td>{{ $item->email }}</td>
                                                    <td>{{ $item->email }}</td>
                                                    <td>{{ $item->licence_no }}</td>
                                                        ...
                                                        <td>
                                                            <form method="POST"
                                                                ...
                                                                <button a
                                                                    class="btn btn-block btn-danger btn-lg mt-1 font-weight-small auth-form-btn"
