...
<head>
    ...
    <link rel="stylesheet" href="{{ url('') }}/public/bootstrap-iso.css" />
...
<body>
                    ...
                    <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
                        ...
                        <ul class="chat-list">
                            <li class="list active">
                                <div class="profile"><img src="{{ url('') }}/public/images/faces/face1.jpg"
                            ...
                            <li class="list">
                                <div class="profile"><img src="{{ url('') }}/public/images/faces/face2.jpg"
                            ...
                            <li class="list">
                                <div class="profile"><img src="{{ url('') }}/public/images/faces/face3.jpg"
                                        alt="image"><span class="online"></span></div>
                                <div class="info">
                                    <p>Daniel Russell</p>
                                    <p>Available</p>
                            ...
                            <li class="list">
                                <div class="profile"><img src="{{ url('') }}/public/images/faces/face4.jpg"
                                        alt="image"><span class="offline"></span></div>
                                <div class="info">
                            ...
                            <li class="list">
                                <div class="profile"><img src="{{ url('') }}/public/images/faces/face5.jpg"
                                        alt="image"><span class="online"></span></div>
                            ...
                            <li class="list">
                                <div class="profile"><img src="{{ url('') }}/public/images/faces/face6.jpg"
                                        alt="image"><span class="online"></span></div>
                                <div class="info">
                                    <p>Sarah Graves</p>
                                    <p>Available</p>
    ...
    <script src="{{ url('') }}/public/js/conditional.js"></script>
