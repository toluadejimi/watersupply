                        ...
                        <form class="pt-3" action="/new-order-now" method="POST">
                            ...
                            @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" required class="form-control form-control-lg" name="delivery_date"
                                        id="exampleInputPassword1" placeholder="Select Date">
                                </div>
                    ...
                    <div class="card">
                        ...
                        <form class="pt-3" action="/new-order-now" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" required class="form-control form-control-lg" value="{{$f_name}} {{$l_name}}"
                                        readonly >
                                </div>

                                <div class="form-group">
                                    <label>Apt | Suit | Room</label>
                                    <input type="text" required class="form-control form-control-lg" value="{{$user_apt}}"
                                        readonly >
                                </div>

                                <div class="form-group">
                                    <label>Street</label>
                                    <input type="text" required class="form-control form-control-lg" value="{{$user_street}}"
                                        readonly >
                                </div>

                                <div class="form-group">
                                    <label>Local Govt</label>
                                    <input type="text" required class="form-control form-control-lg" value="{{$user_lga}}"
                                        readonly >
                                </div>

                                <div class="form-group">
                                    <label>State</label>
                                    <input type="text" required class="form-control form-control-lg" value="{{$user_state}}"
                                        readonly >
                                </div>
