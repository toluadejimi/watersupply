					...
					<table role="presentation"
						...
						<tr>
							<td style="padding:30px;background-color:#ffffff;">
								...
								<p style="margin:0;">We like to inform you that your NGN {{number_format($amount_in_naira)}} has been funded successfuly<br>
						...
						<tr>
							<td style="padding:30px;background-color:#ffffff;">
								<p style="margin:0;">Thanks for choosing Waters<br>
