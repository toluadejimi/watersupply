                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            <div class="brand-logo">
                                <img src="{{ url('') }}/public/assets/img/browsers/product-2-50.png" alt="logo">
                            </div>
                            <h4>Change Email</h4>
                            <h6 class="font-weight-light">Make sure its your valid email</h6>
                            <form class="pt-3" action="/update-email-now" method="POST">
                                @csrf
                                <div class="form-group">
                                    <input type="email" required name="email" class="form-control form-control-lg" id="exampleInputEmail1"
