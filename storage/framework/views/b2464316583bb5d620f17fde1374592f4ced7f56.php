					...
					<table role="presentation"
						...
						<tr>
							<td style="padding:40px 30px 30px 30px;text-align:center;font-size:24px;font-weight:bold;">
								<a href="http://www.example.com/" style="text-decoration:none;"><img
										src="<?php echo e(url('')); ?>/public/assets/img/illustrations/logo.png" width="165" alt="Logo"
						...
						<tr>
							<td style="padding:30px;background-color:#ffffff;">
                                ...
                                <p style="margin:0;">Welcome on Board<br>
								<p style="margin:0;">We are glad you successfully join our platform<br>
							</td>
						</tr>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/watersupply/resources/views/notification/register.blade.php ENDPATH**/ ?>